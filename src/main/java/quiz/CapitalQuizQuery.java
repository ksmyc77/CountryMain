...
public class CapitalQuizQuery implements QuizQuery{
    ...
    public String[] getItems(int id) {
        ...
        for(int i =0; i<4; i++) {
            ...
            //해당 id의 수도를 item에 담아서 전달
            country = dao.getCountryByID(randomId[i]);
            items[i+1] = country.getCapital();
        }
